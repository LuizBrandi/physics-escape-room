...
function preload() {
  ...
  imagemDeFundo = loadImage('images/circuit.jpeg');
  imagemAdicional = loadImage('images/blueprint.jpg');
  imagemResistor = loadImage('images/lampada_apagada.png');
  imagemLampada = loadImage('images/2_pendant_lights.png');
  imagemPilha = loadImage('images/battery.png');
  imagemPilhaCircuito = loadImage('images/battery_circuit.png')
  somCircuitoCorreto = loadSound('audios/light-switch-flip.mp3');
  somCircuitoIncorreto = loadSound('audios/shock.mp3');
